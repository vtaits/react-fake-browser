...
import { Link, type MemoryRouterProps, Route, Switch } from "react-router-dom";
...
export function Example(props: MemoryRouterProps): ReactElement {
	...
	return (
		<Browser {...props} key={key}>
			<Switch>
				<Route path="/one" render={() => <h1>Hello &quot;/one&quot;</h1>} />

				<Route path="/two" render={() => <h1>Hello &quot;/two&quot;</h1>} />

				<Route path="/three" render={() => <h1>Hello &quot;/three&quot;</h1>} />
			</Switch>
